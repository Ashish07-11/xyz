...
@WebFilter({"/fetch-movies", "/delete-movie", "/edit-movie", "/fetch-movies-genre", "/fetch-movies-id",
		"/fetch-movies-language", "/fetch-movies-name", "/fetch-movies-rating","/insert-movie"})
